...
class notepad:
    ...
    def register(self):
        ...
        self.register.label4=Label(self.register,text="Please enter details below",bg="#542681",fg="#ffffff")
        self.register.label4.configure(font=("Constantia",22,"bold"))
        self.register.label4.pack(pady=(30,10))
        
         # Set label for user's instruction
        self.register.label1=Label(self.register, text="Please enter details below", bg="blue").pack()
    ...
    def notepad(self):
        ...
        def about():
            showinfo("Notepad","Notepad by Code With AMAN")
